      ...
      >
        ...
        (
            ...
            <form class="row g-3" >
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-primary mr-7" onClick={handleAdd}>Add Teacher</button>
                   {"     "}   {"     "}  <button type="submit" class=" pl-9 btn btn-warning"  onClick={handleRemove}>Remove Teacher</button>
                </div>
                </form>
            </div>
            <br/><br />
            <div><label for="inputAddress" class="form-label">CHAIRMAN</label>
                    <input type="text" class="form-control" id="inputAddress" placeholder="Enter Address" onChange={(e)=>setChairman(e.target.value)}/></div>
                    <div><button type="submit" class="btn btn-primary mr-7" onClick={handleChair}>changeChairman</button></div>
            <br/><br />
